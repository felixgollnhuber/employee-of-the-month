...
Dabei fiel auf, dass der Journalmarker `coordinator_settle` nach dem Wiederanlauf erst mit dem nächsten Anruf gespeichert wurde. Der Marker wird jetzt sofort geschrieben; 170 Offline-Tests bestehen weiterhin. Dieser Stand läuft seit 20:59 UTC als Release `b5f91514aaab4ab7`, erneut nach einem Neustart außerhalb eines Gesprächs, mit 19 Projekten und ohne Backend-Fehler.
