...
Innerhalb eines laufenden Telefongesprächs unterstützt der Versandpfad außerdem natürliche Folgeanweisungen. Ein exakt im aktuellen Nutzertranskript genannter Thread bleibt kurz sitzungsgebunden, sodass Aussagen wie „Schick dort Test hin“ oder „Mach das“ nach eindeutig genanntem Inhalt ohne starre Befehlssyntax funktionieren. Mehrere mögliche Ziele, fehlende Inhalte und veraltete Bindungen führen zu einer gezielten Rückfrage und keinem Dispatch. Historische Gespräche oder bloße Titelähnlichkeit werden nicht als Sendeberechtigung verwendet.
